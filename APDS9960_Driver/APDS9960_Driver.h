 ...
 * \return ESP_OK or error
 **/
status_t apds_get_longwait_en(APDS_DEV dev, uint8_t *thr);
 ...
 * \return ESP_OK or error
 **/
status_t apds_set_longwait_en(APDS_DEV dev, uint8_t *thr);
 ...
 * \return ESP_OK or error
 **/
status_t apds_get_gst_ext_persist(APDS_DEV dev, uint8_t *val);
 ...
 * \return ESP_OK or error
 **/
status_t apds_set_gst_ext_persist(APDS_DEV dev, uint8_t *val);
 ...
 * \return ESP_OK or error
 **/
status_t apds_get_red_data(APDS_DEV dev, uint16_t *d);
 ...
 * \return ESP_OK or error
 **/
status_t apds_get_blue_data(APDS_DEV dev, uint16_t *d);
 ...
 * \return ESP_OK or error
 **/
status_t apds_get_green_data(APDS_DEV dev, uint16_t *d);
 ...
 * \return ESP_OK or error
 **/
status_t apds_get_clear_data(APDS_DEV dev, uint16_t *d);
 ...
 * \return ESP_OK or error
 **/
status_t apds_get_proximity_data(APDS_DEV dev, uint8_t *d);
