...
typedef status_t (*getFunc)(handle_t, void *); /** for ease of conversion, pass in gets & sets as
                                                  pointers **/
 ...
 *        Fix with signed bit in MSB
 * **/
#define DATATYPE_SIGNED (1 << 7)

typedef enum datatype {
    DATATYPE_NONE = 0x00,
    DATATYPE_UINT8 = 0x01,
    DATATYPE_INT8 = (0x01 | DATATYPE_SIGNED),
    DATATYPE_UINT16 = 0x02,
    DATATYPE_INT16 = (0x02 | DATATYPE_SIGNED),
    DATATYPE_UINT32 = 0x03,
    DATATYPE_INT32 = (0x03 | DATATYPE_SIGNED),
    DATATYPE_FLOAT = 0x04,
...
typedef enum param_flags { GET_FLAG = 1, SET_FLAG = 2, ACT_FLAG = 4, STREAM_FLAG = 8 } param_flag_t;
