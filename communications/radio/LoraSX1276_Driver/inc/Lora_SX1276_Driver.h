...
typedef struct {
    ...
    gpio_num_t irq_pin;
    uint32_t spi_bus;
    void *spi_device; /** optional spi device settings - see README */
} sx1276_init_t;
...
/**
 * \brief starts the driver task and message queue
 *        The driver is optional but extra tasty :P
 * \param init - pointer to sx_driver_init_t struct
