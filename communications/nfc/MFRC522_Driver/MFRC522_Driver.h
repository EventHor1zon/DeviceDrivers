...
/** TODO: Remove **/
// status_t mfrc_enable_interrupt_pin(MFRC_DEV dev);

// status_t mfrc_disable_interrupt_pin(MFRC_DEV dev);
...
status_t mfrc_get_rx_gain(MFRC_DEV dev, mfrc_rx_gain_t *gain);

status_t mfrc_set_rx_gain(MFRC_DEV dev, mfrc_rx_gain_t *gain);
...
status_t mfrc_set_testbus(MFRC_DEV dev, uint8_t *var);
