 ...
 *
 */
typedef enum { A4988_CMD_STEP_TMR, A4988_CMD_PULSE_TMR, A4988_CMD_UPDATE_PERIOD } a4988_cmd_t;
...
/**
 * @brief Initialises the A4988 Object and returns the driver handle
...
/**
 * @brief Initialises the A4988 control Driver
 *        This driver controls the automated stepping and commands
 *        This task should only be called once
 * @param task_priority - priority of the controller task
 * @param task_buffer - pointer to task stack buffer
 * @param stack_size - size of task stack
 * @param tcb - Pointer to a task control block or other args required in creation
 * @return  Device handle or NULL on error
 */
