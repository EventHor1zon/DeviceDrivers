 ...
 *  \return ESP_OK or error
 */
status_t LSM_reset_device(LSMDEV dev);
 ...
 *  \return ESP_OK or error
 */
status_t LSM_reboot_memory(LSMDEV dev);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_interrupt_1(LSMDEV device, uint8_t *int_t);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_interrupt_2(LSMDEV device, uint8_t *int_t);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_block_data_update_en(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_block_data_update_en(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 */
status_t LSM_run_accel_self_test(LSMDEV dev, bool *passed);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_setOpMode(LSMDEV dev, LSM_OperatingMode_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getOpMode(LSMDEV dev, LSM_OperatingMode_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_setAccelODRMode(LSMDEV dev, LSM_AccelODR_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getAccelODRMode(LSMDEV dev, LSM_AccelODR_t *m);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_setGyroODRMode(LSMDEV dev, LSM_GyroODR_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getGyroODRMode(LSMDEV dev, LSM_GyroODR_t *m);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_accel_full_scale(LSMDEV dev, uint8_t *fs);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_accel_full_scale(LSMDEV dev, uint8_t *fs);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_gyro_full_scale(LSMDEV dev, uint8_t *fs);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_gyro_full_scale(LSMDEV dev, uint8_t *fs);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_accel_bw_select_mode(LSMDEV dev, LSM_AccelBandwidthMode_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_accel_bw_select_mode(LSMDEV dev, LSM_AccelBandwidthMode_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_gyro_sleep_state(LSMDEV dev, LSM_GyroSleepState_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_gyro_sleep_state(LSMDEV dev, LSM_GyroSleepState_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_int2_on_int1_state(LSMDEV dev, uint8_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_int2_on_int1_state(LSMDEV dev, uint8_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_temperature_pkt_en(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_temperature_pkt_en(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_stop_on_fifo_thresh(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_stop_on_fifo_thresh(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_gyro_hp_mode(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_gyro_hp_mode(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_gyro_hpfilter_mode(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_gyro_hpfilter_mode(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_gyro_hp_filter_cutoff(LSMDEV dev, LSM_GyroHighpassCutoff_t *cutoff);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_gyro_hp_filter_cutoff(LSMDEV dev, LSM_GyroHighpassCutoff_t *cutoff);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_accel_lp2_filter_en(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_accel_lp2_filter_en(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_accel_hp_filter_cutoff(LSMDEV dev, LSM_HighpassSlopeSettings_t *cutoff);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_accel_hp_filter_cutoff(LSMDEV dev, LSM_HighpassSlopeSettings_t *cutoff);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_accel_hpfilter_mode(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_accel_hpfilter_mode(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_lowpass_on_6d_mode(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_lowpass_on_6d_mode(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_function_en(LSMDEV dev, bool *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_function_en(LSMDEV dev, bool *mode);


/** \brief: samples latest measurements. Waits status 
 * 
 * **/
status_t LSM_sample_latest(LSMDEV dev);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getGyroX(LSMDEV dev, float *x);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getGyroY(LSMDEV dev, float *y);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getGyroZ(LSMDEV dev, float *z);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getAccelX(LSMDEV dev, float *x);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getAccelY(LSMDEV dev, float *y);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_getAccelZ(LSMDEV dev, float *z);
 ...
 * TODO: Description
 **/
status_t LSM_get_fifo_mode(LSMDEV dev, uint8_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_fifo_mode(LSMDEV dev, LSM_FIFOMode_t *mode);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_fifo_watermark(LSMDEV dev, uint16_t *watermark);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_fifo_watermark(LSMDEV dev, uint16_t *watermark);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_setFIFOpackets(LSMDEV dev, LSM_PktType_t *pktType);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_fifo_step_en(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_fifo_step_en(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_only_msb_data(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_only_msb_data(LSMDEV dev, bool *en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_fifo_step_drdy(LSMDEV dev, uint8_t *on_step_en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_fifo_step_drdy(LSMDEV dev, uint8_t *on_step_en);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_fifo_step_decim(LSMDEV dev, uint8_t *dec);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_fifo_step_decim(LSMDEV dev, uint8_t *dec);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_set_fifo_odr(LSMDEV dev, uint8_t *odr);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_get_fifo_odr(LSMDEV dev, uint8_t *odr);
 ...
 *  \return ESP_OK or error
 **/
status_t LSM_readFifoBlock(LSMDEV device, uint16_t *length);
